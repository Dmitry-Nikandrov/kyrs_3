...
def test_get_excel_df_3(mock_path, get_excel_return):
    ...
    assert get_excel_df("operations_test.xlsx") == [
        {
            "MCC": 5411,
...
def test_get_exchange_rate_1(mock_get):
    ...
    assert get_exchange_rate("user_settings.json") == [
        {"currency": "USD", "exchange_rate": 99.4215},
...
def test_get_stock_price(mock_get):
    mock_get.return_value = [
        {"symbol": "SADL", "price": 18.25, "exchange": "New York Stock Exchange"},
        {"symbol": "AMZN", "price": 227.03, "exchange": "New York Stock Exchange"},
        {"symbol": "IBACU", "price": 98.32, "exchange": "New York Stock Exchange"},
    ]
    assert get_stock_price("None.json") is None
